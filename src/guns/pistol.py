...
class Pistol :
    ...
    def shoot (self ,target_world_pos ):
        ...
        for _ in range (6 ):
            ...
            self .blood .emit_pixel (spawn +pygame .math .Vector2 (random .uniform (-2 ,2 ),random .uniform (-2 ,2 )),vel2 ,color =(255 ,200 ,60 ))
    ...
    def draw (self ,surf ):
        ...
        try :
            ...
            if self .icon is not None :
                ...
                pygame .draw .circle (surf ,(200 ,200 ,40 ),(int (center .x ),int (center .y )),max (6 ,scaling .to_screen_length (8 )))
        except Exception :
            pass 
